...
class WeMapStyles {
  static String WEMAP_VECTOR_STYLE =
      "https://apis.wemap.asia/vector-tiles/styles/osm-bright/style.json?key=GqfwrZUEfxbwbnQUhtBMFivEysYIxelQ";

  static String WEMAP_RASTER_STYLE = "https://apis.wemap.asia/raster-tiles/styles/osm-bright/{x}/{y}/{z}@2x.png?key=GqfwrZUEfxbwbnQUhtBMFivEysYIxelQ";
}
