...
import 'method_channel_wemapgl.dart';
...
abstract class WeMapGlPlatform {
  ...
  static WeMapGlPlatform Function() createInstance =
      () => MethodChannelWeMapGl();
  ...
  Future<bool> addWMSLayer(String layerID, String wmsURL, int tileSize) async {
    throw UnimplementedError(
        'addWMSLayer() has not been implemented.');
  }

  Future<bool> removeWMSLayer(String layerID) async {
    throw UnimplementedError(
        'removeWMSLayer() has not been implemented.');
  }

  Future<bool> addTrafficLayer() async {
    throw UnimplementedError(
        'addTrafficLayer() has not been implemented.');
  }

  Future<bool> removeTrafficLayer() async {
    throw UnimplementedError(
        'removeTrafficLayer() has not been implemented.');
  }

  Future<bool> addSatelliteLayer() async {
    throw UnimplementedError(
        'addSatelliteLayer() has not been implemented.');
  }

  Future<bool> removeSatelliteLayer() async {
    throw UnimplementedError(
        'removeSatelliteLayer() has not been implemented.');
  }
